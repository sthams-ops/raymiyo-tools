...
const glowColorMap = {
  ...
  amber:  { base: 30,  spread: 200 },
  pink:   { base: 330, spread: 200 },
  green:  { base: 120, spread: 200 },
};

export default function GlowCard({ children, glowColor = "blue", style = {}, className = "" }) {
  ...
  const css = `
    ...
    [data-glow]::before {
      background-image: radial-gradient(
        ...
        hsl(var(--hue) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 50) * 1%) / var(--border-spot-opacity, 1)), transparent 100%
      );
      filter: brightness(2);
    }
    [data-glow]::after {
